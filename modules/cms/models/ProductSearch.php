...
class ProductSearch extends Product
{
    ...
    {
        return [
            [['id', 'product_sub_category_id', 'product_category_id', 'brand_id', 'unit_id', 'company_id', 'name', 'product_number', 'description', 'specifications', 'status', 'thumbnail', 'created_by', 'updated_by'], 'safe'],
            [['selling_price', 'compare_price'], 'number'],
