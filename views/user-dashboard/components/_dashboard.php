 <div class=" fade show active" id="pills-dashboard" role="tabpanel"
             ...
             <div class="row g-sm-4 g-3">
                 <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                     <div class="totle-contain">
                         <img src="/web/frontend/assets/images/svg/order.svg"
                             class="img-1 blur-up lazyload" alt="">
                         <img src="/web/frontend/assets/images/svg/order.svg" class="blur-up lazyload"
                             alt="">
                 ...
                 <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                     <div class="totle-contain">
                         <img src="/web/frontend/assets/images/svg/pending.svg"
                             class="img-1 blur-up lazyload" alt="">
