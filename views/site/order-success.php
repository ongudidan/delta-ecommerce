                ...
                <div class="breadscrumb-contain breadscrumb-order">
                    <div class="order-box">
                        ...
                        <div class="order-contain">
                            ...
                            <h5 class="text-content">Your Order Is On The Way</h5>
                            <h6>Order No: <?= $model->order_no ?></h6>
                        </div>
                    </div>
                </div>
            </div>
...
foreach ($model->orderItems as $row) {
    $totalQuantity += $row->quantity;
    $totalPrice += $row->quantity * $row->selling_price;
}
?>
                ...
                <div class="cart-table order-table order-table-2">
                    <div class="table-responsive">
                        <table class="table mb-0">
                            <tbody>
                                <?php foreach ($model->orderItems as $row) { ?>
                                    <tr>
                                        <td class="product-detail">
                                            <div class="product border-0">
                                                ...
                                                <div class="product-detail">
                                                    <ul>
                                                        <li class="name">
                                                            <a href="product-left-thumbnail.html"><?= $row->product->name ?></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <td class="price">
                                            ...
                                            <h6 class="theme-color">Ksh. <?= number_format($row->selling_price) ?></h6>
                                        </td>
                                        ...
                                        <td class="subtotal">
                                            ...
                                            <h5>Ksh. <?= number_format($row->quantity * $row->selling_price) ?></h5>
                                        </td>
                                    </tr>
                                <?php } ?>
                    ...
                    <div class="col-lg-12 col-sm-6">
                        <div class="summery-box">
                            ...
                            <ul class="summery-total">
                                <li class="list-total">
                                    <h4>Total (KES)</h4>
                                    <h4 class="price">Ksh. <?= number_format($totalPrice) ?></h4>
                                </li>
                            </ul>
                        </div>
                    </div>
